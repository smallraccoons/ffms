 ...
 * Generated at: 2019-04-21 07:14:05 UTC
...
public final class securityManage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(cookies != null && cookies.length > 0){
      ...
      out.write("\t\t\t\t\ticonCls=\"icon-add\" onclick=\"openSecurityAddDialog()\" plain=\"true\">添加</a>\r\n");
      out.write("\t\t\t\t\t<a class=\"mini-button\" iconCls=\"icon-edit\"\r\n");
      out.write("\t\t\t\t\tonclick=\"openSecurityModifyDialog()\" plain=\"true\">修改</a> <a\r\n");
      ...
      out.write("\t\t\t\t\t\t持有人：<input id=\"username_search\" class=\"mini-textbox\" /> 证券公司：<input\r\n");
      out.write("\t\t\t\t\t\t\tid=\"company_search\" class=\"mini-textbox\" /> 证券类型：<input\r\n");
      ...
      out.write("\t\t\t\t\t\t\tid=\"dataid_search\" />证券有效期：<input id=\"starttime_search\"\r\n");
      ...
      out.write("\t\t\t<div field=\"username\" width=\"100\" align=\"center\" sortable=\"true\">持有人</div>\r\n");
      out.write("\t\t\t<div field=\"securityname\" width=\"100\" align=\"center\" sortable=\"true\">证券账号</div>\r\n");
      out.write("\t\t\t<div field=\"securitypassward\" width=\"100\" align=\"center\"\r\n");
      out.write("\t\t\t\tsortable=\"true\">证券密码</div>\r\n");
      out.write("\t\t\t<div field=\"company\" width=\"100\" align=\"center\" sortable=\"true\">证券公司</div>\r\n");
      out.write("\t\t\t<div field=\"datadicvalue\" width=\"100\" align=\"center\" sortable=\"true\">证券类型</div>\r\n");
      out.write("\t\t\t<div field=\"starttime\" width=\"100\" align=\"center\" sortable=\"true\"\r\n");
      out.write("\t\t\t\tdateformat=\"yyyy-MM-dd\">证券有效开始时间</div>\r\n");
      out.write("\t\t\t<div field=\"endtime\" width=\"100\" align=\"center\" sortable=\"true\"\r\n");
      out.write("\t\t\t\tdateformat=\"yyyy-MM-dd\">证券有效截止时间</div>\r\n");
      ...
      out.write("\t\tgrid.load({\r\n");
      out.write("\t\t\t\"username\" : mini.get(\"username_search\").value,\r\n");
      out.write("\t\t\t\"company\" : mini.get(\"company_search\").value,\r\n");
      ...
      out.write("\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\ttype : 'post',\r\n");
      out.write("\t\t\t\t\t\turl : 'securitydelete.do',\r\n");
      ...
      out.write("\t\t\t\t\t\tuserid : row.username,\r\n");
      out.write("\t\t\t\t\t\tdataid : row.dataid,\r\n");
      out.write("\t\t\t\t\t\tsecurityname : row.securityname,\r\n");
      out.write("\t\t\t\t\t\tsecuritypassward : row.securitypassward,\r\n");
      out.write("\t\t\t\t\t\tstarttime : row.starttime,\r\n");
      out.write("\t\t\t\t\t\tendtime : row.endtime,\r\n");
      out.write("\t\t\t\t\t\tcompany : row.company,\r\n");
      out.write("\t\t\t\t\t\tid : row.id\r\n");
      out.write("\t\t\t\t\t};\r\n");
