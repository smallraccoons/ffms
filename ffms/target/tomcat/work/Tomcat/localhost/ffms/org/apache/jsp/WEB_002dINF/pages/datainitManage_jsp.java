 ...
 * Generated at: 2019-04-19 02:21:49 UTC
...
public final class datainitManage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(cookies != null && cookies.length > 0){
      ...
      out.write("\tfunction searchDatainit(){\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction deleteDatainit(){\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction beginDatainit(){\r\n");
      out.write("\t\t$.messager.confirm(\"系统提示\",\"数据库初始化将删除数据库中的所有数据，您确认要清空整个数据库吗？\",function(r){\r\n");
      out.write("\t\t\tif(r){\r\n");
      out.write("\t\t\t\t$.messager.progress({\r\n");
      out.write("\t                title:'初始化数据',\r\n");
      out.write("\t                msg:'初始化中，请稍候...'\r\n");
      out.write("\t            });\r\n");
      out.write("\t\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${basePath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("datainit.do\",{userid:\"");
      ...
      out.write("\t\t\t\t\t\t$(\"#dg\").datagrid(\"reload\");\r\n");
      out.write("\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t$.messager.alert(\"系统提示\",\"初始化失败！\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t},\"json\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      ...
      out.write("\t<table id=\"dg\" title=\"数据库初始化\" class=\"easyui-datagrid\"\r\n");
      out.write("\t fitColumns=\"true\" pagination=\"true\" rownumbers=\"true\"\r\n");
      out.write("\t url=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${basePath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("databaselist.do?dataid=3\" fit=\"true\" toolbar=\"#tb\" remoteSort=\"false\" multiSort=\"true\">\r\n");
      out.write("\t <thead>\r\n");
      out.write("\t \t<tr>\r\n");
      ...
      out.write("\t \t\t<th field=\"time\" width=\"100\" align=\"center\" sortable=\"true\">初始化时间</th>\r\n");
      ...
      out.write("\t<div id=\"tb\">\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t\t\t<a href=\"javascript:beginDatainit()\" class=\"easyui-linkbutton\" iconCls=\"icon-undo\" plain=\"true\">初始化数据</a>\r\n");
      out.write("\t\t\t<a href=\"javascript:deleteDatainit()\" class=\"easyui-linkbutton\" iconCls=\"icon-remove\" plain=\"true\">删除记录</a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t\t\t&nbsp;操作人：&nbsp;<input type=\"text\" id=\"s_username\" size=\"20\" onkeydown=\"if(event.keyCode==13) searchDatainit()\"/>\r\n");
      out.write("\t\t\t&nbsp;初始化起止时间：&nbsp;<input type=\"text\" id=\"s_starttime\" class=\"easyui-datetimebox\" size=\"20\" onkeydown=\"if(event.keyCode==13) searchDatainit()\"/>\r\n");
      out.write("\t\t\t<span style=\"font-weight:bold;\">&sim;</span>&nbsp;<input type=\"text\" id=\"s_endtime\" class=\"easyui-datetimebox\" size=\"20\" onkeydown=\"if(event.keyCode==13) searchDatainit()\"/>\r\n");
      out.write("\t\t\t<a href=\"javascript:searchDatainit()\" class=\"easyui-linkbutton\" iconCls=\"icon-search\" plain=\"true\">搜索</a>\r\n");
