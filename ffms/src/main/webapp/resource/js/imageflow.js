...
function ImageFlow() {
    ...
    this.defaults =
	{
	    animationSpeed: 50,             /* 图片转换的时间 */
	    aspectRatio: 3,          /* Aspect ratio of the ImageFlow container (width divided by height) */
	    ...
	    reflectionP: 0.35,            /* Height of the reflection in percent of the source image */
