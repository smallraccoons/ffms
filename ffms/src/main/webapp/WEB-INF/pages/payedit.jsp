		...
		<table>
			...
			<tr>
				...
				<td><input id="datadicvalue" name="datadicvalue"
					class="mini-combobox" class="mini-combobox" url="data/payType.txt"
					textField="text" valueField="id" required="true" /></td>
			</tr>
			<tr>
				<td>支出时间:</td>
				<td><input id="paytime" name="paytime" class="mini-datepicker"
					required="true" /></td>
				<td>备注:</td>
	...
	<script type="text/javascript">
		...
		function SetData(data) {
			if (data.action == "edit") {
				...
				mini.get("payer").setValue(data.payer),
				mini.get("tword").setValue(data.tword),
				mini.get("money").setValue(data.money),
				mini.get("datadicvalue").setValue(data.dataid),
				mini.get("paytime").setValue(data.paytime),
