...
public class PayController {
	...
	public String list(@RequestParam(value = "pageIndex", required = false) String pageIndex,
			...
			@RequestParam(value = "sortOrder", required = false) String sortOrder, Pay s_pay, HttpServletResponse response)
			throws Exception {
	...
	@RequestMapping("/payadd.do")
	public String payadd(ModelMap map, HttpServletRequest request) {
		HttpSession session = request.getSession();
		User curuser = (User)session.getAttribute(Constants.currentUserSessionKey);
		Map<String, Object> userMap = new HashMap<String, Object>();
		userMap.put("userid", curuser.getId());
	...
	@RequestMapping("/payedit.do")
	public String payedit(ModelMap map, HttpServletRequest request) {
		HttpSession session = request.getSession();
		User curuser = (User)session.getAttribute(Constants.currentUserSessionKey);
		Map<String, Object> userMap = new HashMap<String, Object>();
		userMap.put("userid", curuser.getId());
