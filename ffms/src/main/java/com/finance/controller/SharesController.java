...
public class SharesController {
	...
	public String list(@RequestParam(value = "pageIndex", required = false) String pageIndex,
			...
			@RequestParam(value = "sortOrder", required = false) String sortOrder, Shares s_shares, HttpServletResponse response)
			throws Exception {
...
//	}
	...
	@RequestMapping("/sharesadd.do")
	public String sharesadd(ModelMap map, HttpServletRequest request) {
		List<Security> list = securityService.getAllSecurity();
		map.addAttribute("allSecuritys", list);
	...
	@RequestMapping("/sharesedit.do")
	public String sharesedit(ModelMap map, HttpServletRequest request) {
		List<Security> list = securityService.getAllSecurity();
		map.addAttribute("allSecuritys", list);
