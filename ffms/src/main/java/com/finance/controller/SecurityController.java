...
public class SecurityController
{
	...
	public String list(@RequestParam(value = "pageIndex", required = false) String pageIndex,
			...
			@RequestParam(value = "sortOrder", required = false) String sortOrder, Security s_security,
	...
	@RequestMapping("/securityadd.do")
	public String securityadd(ModelMap map, HttpServletRequest request) {
		HttpSession session = request.getSession();
		User curuser = (User)session.getAttribute(Constants.currentUserSessionKey);
		Map<String, Object> userMap = new HashMap<String, Object>();
		userMap.put("userid", curuser.getId());
	...
	@RequestMapping("/securityedit.do")
	public String securityedit(ModelMap map, HttpServletRequest request) {
		HttpSession session = request.getSession();
		User curuser = (User)session.getAttribute(Constants.currentUserSessionKey);
		Map<String, Object> userMap = new HashMap<String, Object>();
		userMap.put("userid", curuser.getId());
