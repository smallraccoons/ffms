...
public class TradeController {
	...
	public String list(@RequestParam(value = "pageIndex", required = false) String pageIndex,
			...
			@RequestParam(value = "sortOrder", required = false) String sortOrder, Trade s_trade, HttpServletResponse response)
			throws Exception {
	...
	public String tradeadd(ModelMap map, HttpServletRequest request) {
		HttpSession session = request.getSession();
		User curuser = (User)session.getAttribute(Constants.currentUserSessionKey);
		Map<String, Object> userMap = new HashMap<String, Object>();
		userMap.put("userid", curuser.getId());
	...
	@RequestMapping("/tradeedit.do")
	public String tradeedit(ModelMap map, HttpServletRequest request) {
		HttpSession session = request.getSession();
		User curuser = (User)session.getAttribute(Constants.currentUserSessionKey);
		Map<String, Object> userMap = new HashMap<String, Object>();
		userMap.put("userid", curuser.getId());
